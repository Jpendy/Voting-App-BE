...
app.use('/api/v1/organizations/average', require('./routes/organizations'));
app.use('/api/v1/users', require('./routes/users'));
app.use('/api/v1/polls', require('./routes/polls'));
app.use('/api/v1/polls/results', require('./routes/polls'));
app.use('/api/v1/polls/average', require('./routes/polls'));
